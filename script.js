function saveToLocalStorage(event){
  ...
  function deleteUserData(userId) {
    axios.delete(`https://crudcrud.com/api/936a96b95a384840ae3de78ec36e6738/appointmentdata/${userId}`)
    .then((response) => {
...
function editUserData(userId) {
    axios.put(`https://crudcrud.com/api/936a96b95a384840ae3de78ec36e6738/appointmentdata/${userId}`)
    .then((response) => {
        console.log(response.data);
    })
    .catch((err) => {
